...
def multiStitching(list_images):
    ...
    # Check if left_pano and right_pano are defined
    if left_pano is not None and right_pano is not None:
        ...
        # Handle case where left_pano or right_pano is not defined
        return None
